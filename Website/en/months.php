<html>
    ...
    <body>
        <div class='verticalizer'>
            <div class='title'><h1>Enter your values and press go<h1 id='pto'>!</h1></h1></div>
            <h2>How many months of GAME PASS until it's worth buying the game(s)?</h2>
            <form id="frm1" action="/action_page.php">
            <h3>Game(s) value</h3><input type="text" name="val"><br>
