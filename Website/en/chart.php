...
<head>
    ...
    <title>Racing Legends - Prices Chart</title>
...
<body>
    <!-- Mobile Leader -->
    <div class="adsbygoogle" id='mobilePippersonAD'><a href="https://www.patreon.com/racing_legends" target='blank'><img src="imgs/AdMobileLeader.png" alt="Help keep the site alive on Patreon" width='320px' height='50px'></a></div>
    
    <!-- Draw graphic elements -->
    <div class='chartContainer' id='chartCont'>
        <canvas id='line-chart'></canvas>
        <a class="btn" href='chooseCar.php'><b><---</b> Choose a car</a>
        ...
        <button class="btn" id='week' onclick="timeChooser('7d')">2w</button>
        <button class="btn" id='month' onclick="timeChooser('1m')">1m</button>
        <button class="btn" id='quarter' onclick="timeChooser('3m')">3m</button>
        <button class="btn" id='year' onclick="timeChooser('1y')">1y</button>
        <button class="btn" id='mbT' onclick="tezao()">T</button>
    </div>

    <!-- Tower Right -->
    <div class="adsbygoogle" id='poripippersonAD'><a href="https://www.patreon.com/racing_legends" target='blank'><img src="imgs/AdVerticalBanner.png" alt="Help keep the site alive on Patreon"></a></div>
    <!-- Mobile Tower Right -->
    <div class="adsbygoogle" id='mobileVerticalAD'><a href="https://www.patreon.com/racing_legends" target='blank'><img src="imgs/AdVerticalBanner.png" alt="Help keep the site alive on Patreon" width='85px' height='320px'></a></div>
