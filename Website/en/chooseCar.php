...
<head>
    ...
    <title>Racing Legends - Choose a car</title>
...
<body>
    ...
    <div class='title'><h1>Choose a car</h1><h1 id='pto'>.</h1></div>
    <h2>MAKE</h2>
    ...
    <button onclick="modelsFinder()">FIND MODELS</button>
    ...
    <button onclick="goToChart()">FIND PRICES</button>
    <button class='goBack' onclick="backToWebsite()">BACK TO THE SITE</button>
    </div>
