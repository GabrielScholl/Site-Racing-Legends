<html>
    ...
    <body>
        <div class='verticalizer'>
            <div class='title'><h1>Insira os dados e aperte vai<h1 id='pto'>!</h1></h1></div>
            <h2>Quantos meses de GAME PASS até valer a pena comprar o(s) jogo(s)?</h2>
            <form id="frm1" action="/action_page.php">
            <h3>Valor do(s) jogo(s)</h3><input type="text" name="val"><br>
            <h3></h3><input type="text" name="lname"><br><br>
            <input type="button" onclick="myFunction()" value="Vai!">
            </form>
        </div>
    </body>
