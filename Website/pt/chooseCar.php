...
<head>
    ...
    <title>Lendas Automotivas - Escolha um carro</title>
...
<body>
    ...
    <div class='title'><h1>Escolha um carro</h1><h1 id='pto'>.</h1></div>
    <h2>MARCA</h2>
    ...
    <button onclick="modelsFinder()">ACHAR MODELOS</button>
    ...
    <select class="dropdn" id="models" name="models" multiple="multiple">
        <script>
            $(document).ready(function() {
                $('#models').select2({
                    placeholder: 'Escolha uma marca primeiro'
                });
            });
    ...
    <button onclick="goToChart()">ACHAR PREÇOS</button>
    <button class='goBack' onclick="backToWebsite()">VOLTAR AO SITE</button>
    </div>
