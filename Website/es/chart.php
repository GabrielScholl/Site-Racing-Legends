...
<head>
    ...
    <title>Leyendas Motorizadas - Gráfico de precios</title>
...
<body>
    <!-- Mobile Leader -->
    <div class="adsbygoogle" id='mobilePippersonAD'><a href="https://www.patreon.com/racing_legends" target='blank'><img src="imgs/AdMobileLeader.png" alt="Ayuda a mantener el sitio vivo en Patreon" width='320px' height='50px'></a></div>
    
    <!-- Draw graphic elements -->
    <div class='chartContainer' id='chartCont'>
        <canvas id='line-chart'></canvas>
        <a class="btn" href='chooseCar.php'><b><---</b> Elige auto</a>
    ...
    <!-- Tower Right -->
    <div class="adsbygoogle" id='poripippersonAD'><a href="https://www.patreon.com/racing_legends" target='blank'><img src="imgs/AdVerticalBanner.png" alt="Ayuda a mantener el sitio vivo en Patreon"></a></div>
    <!-- Mobile Tower Right -->
    <div class="adsbygoogle" id='mobileVerticalAD'><a href="https://www.patreon.com/racing_legends" target='blank'><img src="imgs/AdVerticalBanner.png" alt="Ayuda a mantener el sitio vivo en Patreon" width='85px' height='320px'></a></div>
