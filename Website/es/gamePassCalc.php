<html>
    ...
    <body>
        <div class='verticalizer'>
            <div class='title'><h1>Cuál es tu pregunta</h1><h1 id='pto'>?</h1></div>
            <a href="months.php">¿Cuántos meses de GAME PASS hasta valer la pena comprar el(los) juego(s)?</a>
            <a href="games.php">¿Cuántos juegos debería querer antes de que valga la pena el GAME PASS?</a>
        </div>
    </body>
