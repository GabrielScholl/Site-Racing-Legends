...
def getAllinfo():
    ...
    # checkUntilPixel((300, 191), (255, 255, 255)) # 1080p
...
def grabPrices():
    ...
    time.sleep(0.9) # 0.8 min to work, 0.4 from recording...
    # IN AUCTION TAB
    # enter
    keytap('enter', long=False)
    # ENTERING SEARCH
...
def gameReopener(starting=False):
    ...
    windows = checkIfPixel((34,2130), (255,255,255))
    if windows == True:
        # IN DESKTOP
        # click game
        mouse.position = (190,2134)
        mouse.click(Button.left, 1)
        mouse.position = (3646,954)
        # GAME OPENING
        # wait for press enter
        checkUntilPixel((3507,1987),(255,255,255))
        keytap('enter', long=True)
        # waits to press enter again
        checkUntilPixel((2952,1842),(255,255,255))
        keytap('enter', long=True)
        # esc x2
        checkUntilPixel((3700,1140),(255,255,255))
        keytap('esc', long=True)
        checkUntilPixel((1504,256),(255,255,255))
        keytap('esc', long=True)
        # pg down x2
        checkUntilPixel((2326,288),(255,255,255))
        for i in range(2): keytap('page_down', long=False)
        checkUntilPixel((1240,1048),(255,255,255))
